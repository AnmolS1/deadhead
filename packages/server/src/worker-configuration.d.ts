/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 129c689161cd2cccb3a8a982ffc4b4bf)
// Runtime types generated with workerd@1.20260811.1 2026-08-18 
interface __BaseEnv_Env {
	RATE_LIMIT: KVNamespace;
	DB: D1Database;
	LOBBY: DurableObjectNamespace<import("./worker").LobbyRoom>;
	MATCH: DurableObjectNamespace<import("./worker").MatchRoom>;
	MATCHMAKER: DurableObjectNamespace<import("./worker").Matchmaker>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "LobbyRoom" | "MatchRoom" | "Matchmaker";
	}
